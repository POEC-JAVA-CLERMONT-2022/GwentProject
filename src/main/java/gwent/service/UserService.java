...
public class UserService {
	...
	public void createAccount() {
		...
		inputUsername = consoleDisplay.readUserInput();

		// enter email
		do {
			consoleDisplay.printToConsole("Enter the email of your user: ", true);
			inputEmail = consoleDisplay.readUserInput();
			matcher = emailValidation.matcher(inputEmail);
		...
		inputPwd = consoleDisplay.readUserInput();

		// confirm
		consoleDisplay.printToConsole("Create user " + inputUsername + " with these settings? (Yes/No)", true);
		consoleDisplay.printToConsole("Email: " + inputEmail, true);
		consoleDisplay.printToConsole("Password: " + inputPwd, true);
